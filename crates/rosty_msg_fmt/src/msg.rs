...
impl Msg {
    ...
    pub fn header_token_stream<T: ToTokens>(&self, _crate_prefix: &T) -> impl ToTokens {
        if !self.has_header() {
            return quote! {};
        }
        quote! {
            fn header(&self) -> Option<&super::std_msgs::Header> {
                Some(&self.header)
            }

            fn header_mut(&mut self) -> Option<&mut super::std_msgs::Header> {
...
mod tests {
    ...
    fn message_md5_string_correct() {
        ...
        assert_eq!(
            Msg::new(
                ...
                include_str!("../../rosty_msg/msg_examples/geometry_msgs/msg/Point.msg"),
            )
            .unwrap()
            .calculate_md5(&HashMap::new())
            .unwrap(),
        ...
        assert_eq!(
            Msg::new(
                ...
                include_str!("../../rosty_msg/msg_examples/geometry_msgs/msg/Quaternion.msg"),
            )
            .unwrap()
            .calculate_md5(&HashMap::new())
            .unwrap(),
        ...
        assert_eq!(
            Msg::new(
                ...
                include_str!("../../rosty_msg/msg_examples/geometry_msgs/msg/Pose.msg"),
            )
            .unwrap()
        ...
        assert_eq!(
            Msg::new(
                ...
                include_str!("../../rosty_msg/msg_examples/visualization_msgs/msg/ImageMarker.msg"),
            )
            .unwrap()
            .calculate_md5(&hashes)
            .unwrap(),
    ...
    fn match_lines_parses_real_messages() {
        let data = match_lines(include_str!(
            "../../rosty_msg/msg_examples/geometry_msgs/msg/TwistWithCovariance.msg"
        ))
        .unwrap();
        assert_eq!(
            vec![
        ...
        let data = match_lines(include_str!(
            "../../rosty_msg/msg_examples/geometry_msgs/msg/PoseStamped.msg"
        ))
        .unwrap();
        assert_eq!(
            vec![
    ...
    fn msg_constructor_parses_real_message() {
        let data = Msg::new(
            ...
            include_str!("../../rosty_msg/msg_examples/geometry_msgs/msg/TwistWithCovariance.msg"),
        )
        .unwrap();
        ...
        let data = Msg::new(
            ...
            include_str!("../../rosty_msg/msg_examples/geometry_msgs/msg/PoseStamped.msg"),
        )
        .unwrap();
        assert_eq!(data.path.package, "geometry_msgs");
        ...
        let data = Msg::new(
            ...
            include_str!("../../rosty_msg/msg_examples/sensor_msgs/msg/Imu.msg"),
        )
        .unwrap();
